...
ggmap(continentalUS) + 
  ...
  scale_size_manual(values = c("B" = 0.1, "C" = 0.2, "D" = 0.3, "E" = 0.4, "F" = 0.5, "G" = 0.6)) +
  # not actually sure this works, also need to add legend
  theme_map()
...
# anina visualizations

### by size

size over entire time period
...
some more time things i want to try
