...
```{r}
date_range <- which(idatex$disc_clean_date %in% as.Date(c("1997-12-16", "1997-10-20", "1997-01-18")))

ggplot(idatex, aes(x = disc_clean_date, fill = state)) + 
  geom_vline(xintercept = FiresClean$disc_clean_date[date_range], color = "lightskyblue") + 
  geom_density(alpha = .65, color = 'white') + 
