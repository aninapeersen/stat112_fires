...
As shown in the faceted density plot below, fires are generally cyclical. The same spikes seen in the entire data set shown above are also present when faceted by size classification. 
